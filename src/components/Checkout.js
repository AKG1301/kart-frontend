...
class Checkout extends React.Component {
   ...
   * If the user is logged in (i.e. the localStorage fields for `username` and `token` exist), call getProducts() and getAddresses() to fetch products and addresses from backend to state
   * Else, show an error message indicating that the user must be logged in first and redirect the user to the root page
   * Update the balance state variable with the localStorage field
   */
